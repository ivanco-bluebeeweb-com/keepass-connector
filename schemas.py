"""Pydantic schemas for KeePass KeePassXC Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary KeePass KeePassXC.")
    api_key: str = Field(description="Enterprise API Key / Access Token")
    base_url: str = Field(default="http://127.0.0.1:19455", description="KeePass KeePassXC API base URL.")
...
class GetVaultItemParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    vaultitem_id: str = Field(description="KeePass KeePassXC VaultItem ID.")
